...
export const projects: Project[] = [
  {
    title: "Research Project Standards",
    slug: "research-project-standards",
    tags: ["Study", "Publication"],
    status: "Active",
    leadAffiliateSlug: "elara-reed",
    teamAffiliateSlugs: ["maya-okafor", "jonas-xu"],
    summary: "What makes a good MOS research Project?",
    description: "",
    methods: [],
    datasets: [],
    outputs: [
    ...
    featuredImage: "/assets/barracuda.png",
    embedUrl:
      "https://docs.google.com/document/d/1reOwyaosEQytIb3CPme-c30x2j969Bm-44XP_FAubQI/preview",
